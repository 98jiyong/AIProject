...
avg_temperature = st.number_input("평균 기온 (°C)", min_value=-30.0, max_value=50.0, value=0.0)
avg_humidity = st.number_input("평균 습도 (%)", min_value=0.0, max_value=100.0, value=0.0)
solar_radiation = st.number_input("일사량 (MJ/m2)", min_value=0.0, value=0.0)
